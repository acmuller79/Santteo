    ...
    <section id="beer-catalog-section" className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-center max-w-xl mx-auto mb-6">
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
          Catálogo de Barris de 30L e 50L
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filteredBeers.map((beer) => (
          ...
          >
            ...
            {/* Pricing (30L and 50L only) and Action Buttons */}
            <div className="pt-3 border-t border-stone-800/80">
              <div className="grid grid-cols-2 gap-2 mb-3 text-xs">
                <div className="text-center bg-stone-950 px-3 py-2 rounded-xl border border-stone-800">
                  <span className="text-[10px] text-stone-400 block font-medium">Barril de 30 Litros</span>
                  <strong className="text-white text-sm font-bold">{beer.price30L ? formatCurrency(beer.price30L) : 'Consulte'}</strong>
                </div>
                <div className="text-center bg-stone-950 px-3 py-2 rounded-xl border border-amber-500/40 shadow-sm">
                  <span className="text-[10px] text-amber-400 block font-semibold">Barril de 50 Litros</span>
                  <strong className="text-amber-400 text-sm font-bold">{beer.price50L ? formatCurrency(beer.price50L) : 'Consulte'}</strong>
                </div>
              </div>
